...
```{r vis2, out.width = "80%", fig.align='center', fig.cap='distribution des scores', echo=FALSE, dpi=300, eval=!params$time}
be_vis
```
...
```{r vis3, out.width = "80%", fig.align='center', fig.cap='distribution des scores', echo=FALSE, dpi=300, eval=!params$time}
be_vis
```
