...
p_all <- print("Les données concernent toutes les classes ayant participé à ce jour en 2020-2021.")
...
```{r eval=params$save}
export(peers, "peers_save.xlsx")
export(teach, "teach_save.xlsx")
...
```{r eval=params$all, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r teach, tab.id="teach", tab.cap = "Résumé des données concernant l'enseignement", tab.cap.style="caption_nb", eval=!params$time}
...
```{r teach_1, tab.id="teach", tab.cap = "Résumé des données concernant l'enseignement respectivement aux temps 1 et 2", tab.cap.style="caption_nb", eval=params$time}
...
```{r teach_2, tab.id="teach", tab.cap = "Résumé des données concernant l'enseignement respectivement aux temps 1 et 2", tab.cap.style="caption_nb", eval=params$time}
...
```{r peers, tab.id="peers", tab.cap = "Résumé des scores de bien-être", tab.cap.style="caption_nb", eval=!params$time}
fl3_w <- 6.3/ncol(peers_sum)
fl3 <- flextable::flextable(peers_sum)
fl3 <- flextable::set_header_labels(fl3, classe = "Classe", mean = "Moyenne", max = "Score maxium", min = "Score minimum", median = "Médiane", std = "Ecart-type")
...
```{r peers_1, tab.id="peers", tab.cap = "Résumé des scores de bien-être respectivement aux temps 1 et 2", tab.cap.style="caption_nb", eval=params$time}
fl31_w <- 6.3/ncol(peers_sum_1)
fl31 <- flextable::flextable(peers_sum_1)
fl31 <- flextable::set_header_labels(fl31, classe = "Classe", mean = "Moyenne", max = "Score maxium", min = "Score minimum", median = "Médiane", std = "Ecart-type")
...
```{r peers_2, tab.id="peers", tab.cap = "Résumé des scores de bien-être respectivement aux temps 1 et 2", tab.cap.style="caption_nb", eval=params$time}
fl32_w <- 6.3/ncol(peers_sum_2)
fl32 <- flextable::flextable(peers_sum_2)
fl32 <- flextable::set_header_labels(fl32, classe = "Classe", mean = "Moyenne", max = "Score maxium", min = "Score minimum", median = "Médiane", std = "Ecart-type")
...
```{r vis, fig.id="vis", fig.align='center', out.width = "100%", fig.retina = 3, fig.show = "hold", fig.cap='distribution des scores', echo=FALSE, eval=!params$time}

be_vis
```


```{r vis_1_2,fig.id="vis", fig.align='center', out.width = "100%", fig.retina = 3, fig.show = "hold", fig.cap='distribution des scores', echo=FALSE, eval=params$time}
...
La représentation graphique  \@ref(fig:vis2) nous donne une idée de la distribution des scores.

```{r vis2, fig.id="vis2", fig.align='center', out.width = "100%", fig.retina = 3, fig.show = "hold", fig.cap='distribution des scores', echo=FALSE, eval=!params$time}

emo_vis
```


```{r vis2_1_2,fig.id="vis2", fig.align='center', out.width = "100%", fig.retina = 3, fig.show = "hold", fig.cap='distribution des scores', echo=FALSE, eval=params$time}
...
La représentation graphique  \@ref(fig:vis3) nous donne une idée de la distribution des scores.

```{r vis3, fig.id="vis3", fig.align='center', out.width = "100%", fig.retina = 3, fig.show = "hold", fig.cap='distribution des scores', echo=FALSE, eval=!params$time}

cps_vis
```


```{r vis3_1_2,fig.id="vis3", fig.align='center', out.width = "100%", fig.retina = 3, fig.show = "hold", fig.cap='distribution des scores', echo=FALSE, eval=params$time}
