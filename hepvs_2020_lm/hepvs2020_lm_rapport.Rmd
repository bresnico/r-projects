...
- 2 temps de mesure
- 5 classes
- 2 conditions ( 3 classes expé et 2 contrôle)
...
résumé temps 1, temps 2

```{r table_t1, echo=FALSE}

knitr::kable(d_date, caption="résumé des données de l'échantillon au temps 1 et au temps 2", label="temps1_2")
```
