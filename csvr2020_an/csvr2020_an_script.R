...
# Importation des données brutes (N=155) sous la forme d'une répartition en 4 temps. On a déjà supprimé les ID invalides auparavant (p.ex. "test") en repérant visuellement la structure de chaque ID (forme acceptée de type: abcd01). On a supprimé les colonnes avec infomations méta inutiles de qualtrics.

d <- read_excel("../../data/csvr2020_an_raw.xlsx") #les variables ont été correctement importées.

#######################
#travail sur les dates#
#######################

# modification de la variable "RecordedDate" en "date" en temps 1, temps 2, temps 3, temps 4.
...
# Variante d'analyse sans pairage longitudinal

# On est prêts à résumer (tableaux + graphs)

# ICI



# Variante avec repérage des ID sur 3 voire 4 temps....
