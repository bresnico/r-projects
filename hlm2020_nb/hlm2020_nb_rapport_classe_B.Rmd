---
title: "Présentation des premières données - Classe B"
...
fl <- flextable::flextable(sample_b)
...
fl2 <- flextable::flextable(teach_sum_b)
...
fl3 <- flextable::flextable(peers_sum_b)
