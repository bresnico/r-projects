...
En tout, au 23 mars 2021, j'ai reçu officiellement les coordonnées de 8 classes :

- 5 classes dans le cycle 1
...
fl2 <- set_header_labels(fl2, clas="Classe", sco_gp="Gestion proactive", sco_gr="Gestion réactive", sco_ip="Impl. des parents", sco_ie="Impl. externe",sco_tot="Total")
...
## Tableau des opportunités et risques
